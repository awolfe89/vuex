<template>
  <div class="all">
    <div class="loader" v-if="loading">
      <v-sheet :color="`grey ${theme.isDark ? 'darken-2' : 'lighten-4'}`" class="px-5 pt-3 pb-3">
        <v-skeleton-loader
    ...
    <v-container v-if="!loading">
      <div>
        <v-app-bar color="red" dark>
          ...
          <v-spacer></v-spacer>
          <v-select label="Brand" v-model="searchBrand" :items="brandsList" @change="seachChange" />
          ...
          <div class="d-flex flex-no-wrap justify-space-between">
            <div>
              ...
              <v-card-actions>
                ...
                >
                  <v-btn color="blue" text>View</v-btn>
                </router-link>

                <v-btn color="blue" text>Buy Now</v-btn>
              </v-card-actions>
            </div>
          </div>
        </v-card>
